      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          ...
          <div className="flex items-center gap-6">
            <Button variant="outline" size="icon" className="w-20 h-20 rounded-2xl border-white/10 bg-white/5 backdrop-blur-md hover:bg-white/10 text-white transition-all hover:-translate-y-1">
              <a href={process.env.NEXT_PUBLIC_FACEBOOK_URL} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-full h-full">
                <Facebook className="w-10 h-10" />
              </a>
            </Button>
            <Button variant="outline" size="icon" className="w-20 h-20 rounded-2xl border-white/10 bg-white/5 backdrop-blur-md hover:bg-white/10 text-white transition-all hover:-translate-y-1">
              <a href={process.env.NEXT_PUBLIC_INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-full h-full">
                <Instagram className="w-10 h-10" />
              </a>
            </Button>
            <Button variant="outline" size="icon" className="w-20 h-20 rounded-2xl border-white/10 bg-white/5 backdrop-blur-md hover:bg-white/10 text-white transition-all hover:-translate-y-1">
              <a href={process.env.NEXT_PUBLIC_TIKTOK_URL} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-full h-full">
