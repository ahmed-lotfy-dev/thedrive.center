...
export function CarsGalleryView({ allCars, meta, search, serviceType, isLoading }: CarsGalleryViewProps) {
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-emerald-500/5 dark:bg-emerald-500/10 rounded-full blur-[120px] pointer-events-none -z-10 translate-x-1/2 -translate-y-1/2" />
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-emerald-500/5 dark:bg-emerald-500/10 rounded-full blur-[120px] pointer-events-none -z-10 -translate-x-1/2 translate-y-1/2" />
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          <motion.div variants={itemVariants}>
            <Badge variant="outline" className="text-emerald-500 border-emerald-500/20 bg-emerald-500/5 px-6 h-10 rounded-full font-black uppercase tracking-[0.2em] text-xs sm:text-sm shadow-sm">
          ...
          <div className="space-y-6 max-w-4xl">
            ...
            >
              سيارات تم <span className="text-transparent bg-clip-text bg-linear-to-l from-emerald-500 to-emerald-600 dark:from-emerald-400 dark:to-emerald-400 drop-shadow-sm">خدمتها</span> باحترافية
            </motion.h1>
          </div>
        </motion.div>
        ...
        {isLoading ? (
          ...
          >
            ...
            <h2 className="text-3xl font-black text-foreground tracking-tight">لا توجد أعمال تطابق بحثك</h2>
            <p className="text-zinc-500 dark:text-zinc-400 mt-3 font-medium text-lg">جرب البحث بكلمات مختلفة أو تصفح كل الخدمات.</p>
          </motion.div>
        )}
      </div>
    </div>
