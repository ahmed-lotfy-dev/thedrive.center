...
export function FAQ() {
  return (
    <section id="faq" className="container mx-auto px-4 py-20 md:py-32" data-animate>
      <div className="grid lg:grid-cols-2 gap-16 items-start">
        <div className="space-y-6">
          ...
          <div className="p-8 rounded-3xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 relative overflow-hidden group">
        ...
        <div className="surface p-6 md:p-10 rounded-4xl md:rounded-[3rem] border-zinc-200/60 dark:border-zinc-800/60">
