    ...
    >
      <div className="grid lg:grid-cols-2 gap-16 items-start">
        ...
        >
          ...
          <motion.h2
            className="text-4xl md:text-5xl font-black text-zinc-900 dark:text-white leading-tight"
          ...
          >
            <Card className="bg-card/40 backdrop-blur-md border border-emerald-500/20 relative overflow-hidden group transition-all duration-500 hover:shadow-2xl hover:shadow-emerald-500/5 py-8 hover:border-emerald-500/40">
        ...
        <motion.div
          ...
          transition={{ duration: 0.5, ease: [0.22, 1, 0.36, 1], delay: 0.2 }}
        >
          <Card className="bg-card/40 backdrop-blur-md p-6 md:p-10 rounded-4xl md:rounded-[3rem] border border-emerald-500/20 shadow-xl py-10 hover:border-emerald-500/40 transition-all duration-500">
            <CardContent>
              <Accordion type="single" collapsible className="w-full space-y-4">
                {faqs.map((faq, idx) => (
                  <motion.div
                    ...
                    whileInView={prefersReducedMotion ? undefined : { y: 0, opacity: 1 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.4, ease: [0.22, 1, 0.36, 1], delay: 0.25 + idx * 0.08 }}
                  >
                    <AccordionItem 
                      value={`faq-${idx}`} 
