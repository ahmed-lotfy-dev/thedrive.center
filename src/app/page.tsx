...
export default function Home() {
  return (
    <main dir="rtl" className="overflow-x-hidden pb-10 pt-24 md:pt-28">
      <section className="relative px-4 pb-20 pt-8 md:pt-12 ambient-grid">
        ...
        <div className="container mx-auto">
          <div className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="space-y-6" data-animate>
              ...
              <h1 className="max-w-3xl text-balance text-5xl font-semibold leading-tight md:text-6xl">
              ...
              <div className="grid max-w-2xl grid-cols-2 gap-3 pt-2 md:grid-cols-3">
                ...
                <article className="surface col-span-2 p-4 md:col-span-1">
                  <p className="text-xs text-muted-foreground">موقعنا</p>
