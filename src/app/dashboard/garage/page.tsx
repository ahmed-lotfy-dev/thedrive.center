    ...
    <div className="space-y-12 pb-20">
      <div className="flex flex-col gap-3">
        <h1 className="text-4xl sm:text-6xl font-black tracking-tighter italic uppercase leading-none">
          عربياتي{" "}
          <span className="text-emerald-500 block sm:inline">My Garage</span>
        </h1>
        <p className="text-muted-foreground font-bold text-lg max-w-2xl">
          هنا يمكنك متابعة حالة سياراتك، سجلات الصيانة السابقة، ومعرفة موعد
          الخدمة القادم بدقة لضمان أفضل أداء لسيارتك.
        </p>
      </div>

      <GarageDashboard initialCars={cars || []} meta={meta} />
    </div>
  );
}
