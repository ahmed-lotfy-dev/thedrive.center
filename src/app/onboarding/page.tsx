  ...
  return (
    <main dir="rtl" className="min-h-screen bg-background relative flex flex-col items-center pt-28 md:pt-40 lg:pt-48 pb-20 px-4">
      ...
      <div className="w-full max-w-xl animate-in fade-in slide-in-from-bottom-4 duration-1000">
        <div className="bg-card dark:bg-slate-900/40 backdrop-blur-xl rounded-[2.5rem] shadow-2xl overflow-hidden border border-slate-200/50 dark:border-slate-800/50">
          <div className="bg-linear-to-br from-emerald-500/90 via-emerald-600 to-slate-900 p-10 text-white text-center relative overflow-hidden">
            {/* Glossy overlay */}
